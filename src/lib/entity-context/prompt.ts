...
export function buildEntityContextSystemPrompt(
  ...
  return [
    ...
    "- NO propongas stage_change ni tasks; el contexto de entidad solo enriquece perfil y campos.",
    "- Usá nombres de campo camelCase del CRM (description, industry, roleTitle, mainPain, linkedinUrl, etc.).",
    "- Para company podés proponer campos comerciales estándar: source, priority, mainPain, productInterest, potentialValue, buyingTiming, urgency, competitor, currentProvider, nextStep, nextStepDueDate, lastContactAt.",
    "- No inventes fechas ni montos: nextStepDueDate y lastContactAt solo si hay fecha explícita o inferencia clara; potentialValue solo si aparece monto, presupuesto o valor comercial claro.",
    "- Para fechas usá formato ISO YYYY-MM-DD. Para potentialValue usá solo número, sin símbolo de moneda.",
    "- priority, urgency, buyingTiming y source son texto libre en v1; copiá el lenguaje de la fuente si es claro.",
