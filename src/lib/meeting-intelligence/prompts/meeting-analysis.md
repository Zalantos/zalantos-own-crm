...
Recibís:
- El estado actual del CRM (empresa, oportunidad, contactos, notas y actividades recientes, reuniones previas).
- La transcripción / texto de la nueva reunión.

Reglas generales:
- Basate SOLO en lo que la evidencia respalda. No inventes datos.
- Si algo no aparece en la reunión, no lo propongas.
